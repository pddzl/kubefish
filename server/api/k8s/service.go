...
func (sa *ServiceApi) GetServices(c *gin.Context) {
	...
	list, total, err := serviceService.GetServices(cListReq.Namespace, cListReq.Label, cListReq.Field, cListReq.PageInfo)
	if err != nil {
...
func (sa *ServiceApi) DeleteService(c *gin.Context) {
	...
	if err := serviceService.DeleteService(commonReq.Namespace, commonReq.Name); err != nil {
