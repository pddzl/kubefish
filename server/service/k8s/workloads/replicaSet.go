...
func (rs *ReplicaSetService) GetReplicaSets(namespace string, label string, field string, info request.PageInfo) ([]modelK8sWorkloads.ReplicaSetBrief, int, error) {
	// 获取replicaSet list
	...
	// 处理replicaSet数据
	var replicaSetBriefList []modelK8sWorkloads.ReplicaSetBrief
	for _, rsV := range replicaSetList.Items {
		var replicaSetBrief modelK8sWorkloads.ReplicaSetBrief
...
func (rs *ReplicaSetService) GetReplicaSetDetail(namespace string, name string) (*modelK8sWorkloads.ReplicaSetDetail, error) {
	...
	// 处理replicaSet数据
	var replicaSetDetail modelK8sWorkloads.ReplicaSetDetail
	// metadata
	...
	for _, condition := range replicaSet.Status.Conditions {
		var replicaSetCondition modelK8sWorkloads.ReplicaSetCondition
...
func (rs *ReplicaSetService) GetReplicaSetPods(namespace string, name string, info request.PageInfo) ([]modelK8sWorkloads.PodBrief, int, error) {
	// 获取replicaSet原始数据
